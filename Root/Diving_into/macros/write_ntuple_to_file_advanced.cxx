...
conductivity of a material in different conditions of pressure and temperature.
using branches
*/

void write_ntuple_to_file_advanced(std::string outputFileName = "conductivity_experiment.root", unsigned int numDataPoints = 10000){
