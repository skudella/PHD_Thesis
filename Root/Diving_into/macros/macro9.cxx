...
pull( int n_toys = 10000,
    ...
    TH1F* sigma = new TH1F(method_prefix+"sigma",method_prefix+"sigma from gaus fit",50,0.5,1.5);
    ...
    // Make nice canvases
    TCanvas* c1 = new TCanvas(method_prefix+"Result",method_prefix+"Sigma-Distribution",0,300,600,400);
